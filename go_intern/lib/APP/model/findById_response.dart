...
UserFindByIdResponse costumerFromJson(String str) =>
    UserFindByIdResponse.fromJson(json.decode(str));
...
class UserFindByIdResponse {
  ...
  factory UserFindByIdResponse.fromJson(Map<String, dynamic> json) =>
      UserFindByIdResponse(
...
class Body {
  ...
  factory Body.fromJson(Map<String, dynamic> json) => Body(
      ...
      suratLamaran:
          json['surat_lamaran'] == null ? "null" : json['surat_lamaran'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "agama": agama,
        "tangal_lahir":
            "${tangalLahir.year.toString().padLeft(4, '0')}-${tangalLahir.month.toString().padLeft(2, '0')}-${tangalLahir.day.toString().padLeft(2, '0')}",
        "token": token,
        "cv": cv,
        "resume": resume,
        "status": status,
